...
% \section{The packages \pkg{spatialreg}, \pkg{spdep}, \pkg{splm}, and \pkg{sphet}}
...
% impac1 <- splm:::impacts.splm(respatlag, 
%                               listw = mat2listw(usaww, style = "W"), 
%                               time = 17)
